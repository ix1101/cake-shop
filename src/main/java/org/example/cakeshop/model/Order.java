package org.example.cakeshop.model;
...
import org.example.cakeshop.utils.PriceUtil;
...
public class Order {
    ...
    private Map<Integer, OrderItem> itemMap = new HashMap<Integer, OrderItem>();// 订单商品map
    private List<OrderItem> itemList = new ArrayList<OrderItem>();// 订单商品列表
